      ...
      <div className="container mx-auto px-4 md:px-12">
        ...
        <div className="max-w-3xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10">
            <div>
              <h3 className="text-lg md:text-xl font-medium mb-3 md:mb-4">基本情報</h3>
            ...
            <div>
              <h3 className="text-lg md:text-xl font-medium mb-3 md:mb-4">学歴</h3>
              <div>
          ...
          <div className="mt-8 md:mt-12 pt-8 md:pt-12 border-t border-gray-100">
            <h3 className="text-lg md:text-xl font-medium mb-3 md:mb-4">MBTI</h3>
            <div className="flex flex-col md:flex-row md:items-start gap-4 md:gap-6">
              <div className="bg-gray-50 p-4 md:p-6 rounded-lg">
                <div className="flex items-center gap-3 md:gap-4 mb-2 md:mb-3">
                  ...
                  <img
                    ...
                    alt="INTP"
                    className="w-12 h-12 md:w-16 md:h-16 object-cover rounded-full border-2 border-blue-100"
                  />
                </div>
              ...
              <div>
                <p className="font-medium mb-2 md:mb-4">相性のいいタイプ</p>
                <div className="grid grid-cols-3 gap-2 md:gap-4">
                  <div className="flex flex-col items-center">
                    <img
                      src="/images/mbti/esfp.jpeg"
                      alt="ESFP"
                      className="w-16 h-16 md:w-20 md:h-20 object-cover rounded-lg shadow-sm mb-2"
                    />
                    <span className="px-2 py-1 bg-blue-50 text-blue-700 rounded-full text-xs md:text-sm">ESFP</span>
                  </div>
                  ...
                  <div className="flex flex-col items-center">
                    <img
                      ...
                      className="w-16 h-16 md:w-20 md:h-20 object-cover rounded-lg shadow-sm mb-2"
                    />
                    <span className="px-2 py-1 bg-blue-50 text-blue-700 rounded-full text-xs md:text-sm">ISFJ</span>
                  </div>
                  ...
                  <div className="flex flex-col items-center">
                    <img
                      ...
                      className="w-16 h-16 md:w-20 md:h-20 object-cover rounded-lg shadow-sm mb-2"
                    />
                    <span className="px-2 py-1 bg-blue-50 text-blue-700 rounded-full text-xs md:text-sm">ENTJ</span>
                  </div>
                </div>
              </div>
            </div>
