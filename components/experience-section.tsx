...
export default function ExperienceSection() {
  return (
    <section id="experience" className="py-12 md:py-32 bg-white relative overflow-hidden mobile-dark">
      {/* 背景装飾 */}
      <div className="absolute inset-0 section-pattern opacity-30"></div>
      <div className="absolute top-1/4 left-0 w-96 h-96 bg-blue-100 dark:bg-blue-900/30 rounded-full mix-blend-multiply filter blur-3xl opacity-20"></div>
      <div className="absolute bottom-1/4 right-0 w-96 h-96 bg-indigo-100 dark:bg-indigo-900/30 rounded-full mix-blend-multiply filter blur-3xl opacity-20"></div>
          ...
          <div className="relative border-l-2 border-gradient-to-b from-blue-400 to-indigo-600 pl-4 md:pl-8 pb-8 md:pb-16 animate-fadeIn">
            ...
            <div className="mb-10">
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-6">
                ...
                <div className="rounded-xl overflow-hidden shadow-md flex items-center justify-center bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm p-4 border border-gray-100 dark:border-gray-700 hover-lift">
                  <img
