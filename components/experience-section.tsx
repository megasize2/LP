...
export default function ExperienceSection() {
  return (
    ...
    >
      ...
      <div className="absolute top-1/4 left-0 w-96 h-96 bg-blue-600/10 rounded-full mix-blend-multiply filter blur-3xl opacity-15"></div>
      <div className="absolute bottom-1/4 right-0 w-96 h-96 bg-indigo-600/10 rounded-full mix-blend-multiply filter blur-3xl opacity-15"></div>
          ...
          <div className="relative border-l-2 border-blue-500/50 pl-4 md:pl-8 pb-8 md:pb-16 animate-fadeIn">
            ...
            <div className="mb-10">
              <div className="flex items-center mb-2">
                ...
                <h3 className="text-lg md:text-xl font-medium highlight-text important-text">株式会社tetra Core</h3>
              </div>
              <p className="text-white mb-4 text-sm md:text-base font-medium text-outline">現在</p>

              <div className="grid md:grid-cols-2 gap-6 mb-6">
                <div className="futuristic-card p-3 md:p-6 rounded-xl important-section">
                  <p className="text-white leading-relaxed mobile-readable text-outline">
                    株式会社tetra
                    Coreでは、最新のテクノロジーを活用したソリューション開発に携わっています。特に生成AIの活用に力を入れ、革新的なサービス提供を目指しています。
                  </p>
                </div>

                <div className="rounded-xl overflow-hidden shadow-md flex items-center justify-center bg-black/90 backdrop-blur-sm p-4 border border-blue-500/40 hover-lift">
                  <img
          ...
          <div className="relative border-l-2 border-indigo-500/50 pl-4 md:pl-8 pb-8 md:pb-16 animate-fadeIn animate-delay-200">
            ...
            <div>
              <div className="flex items-center mb-2">
                ...
                <h3 className="text-lg md:text-xl font-medium highlight-text important-text">オフィス機器販売営業</h3>
              </div>
              <p className="text-white mb-2 md:mb-4 text-sm md:text-base font-medium text-outline">9年間（BtoB）</p>
              ...
              <div className="grid md:grid-cols-2 gap-3 md:gap-6">
                ...
                <div className="futuristic-card p-3 md:p-6 rounded-xl md:order-2 order-1 important-section">
                  <p className="text-white leading-relaxed mobile-readable text-outline">
          ...
          <div className="relative border-l-2 border-purple-500/50 pl-4 md:pl-8 animate-fadeIn animate-delay-300">
            ...
            <div className="mb-6">
              <div className="flex items-center mb-2">
                ...
                <h3 className="text-lg md:text-xl font-medium highlight-text important-text">家電量販店 販売営業</h3>
              </div>
              <p className="text-white mb-2 md:mb-4 text-sm md:text-base font-medium text-outline">3年間（BtoC）</p>
