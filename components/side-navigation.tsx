...
export function SideNavigation() {
  ...
  return (
    <div className="fixed right-6 top-1/2 transform -translate-y-1/2 z-50 hidden lg:block !hidden lg:!block">
      <motion.nav
        className="flex flex-col space-y-3 bg-black/80 backdrop-blur-md p-3 rounded-full shadow-xl"
