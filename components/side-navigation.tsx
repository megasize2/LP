...
export default function SideNavigation() {
  ...
  return (
    <div className="fixed right-4 top-1/2 transform -translate-y-1/2 z-50 hidden md:block">
      <div className="modern-card py-4 px-2 rounded-full">
            ...
            <li key={item.id}>
              <a
                ...
                className={`flex flex-col items-center justify-center group relative ${
                  activeSection === item.id ? "text-[#0066ff]" : "text-gray-500 hover:text-[#0066ff]"
                }`}
              >
                <div
                ...
                <span className="absolute right-full mr-2 modern-card text-xs px-2 py-1 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap">
                  {item.label}
                </span>
              </a>
            </li>
