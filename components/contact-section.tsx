...
export default function ContactSection() {
  ...
  return (
    <section
      id="contact"
      className="py-12 md:py-32 bg-black circuit-bg relative overflow-hidden mobile-dark section-overlay"
    >
      {/* 背景装飾 - 透明度を下げる */}
      <div className="absolute inset-0 tech-grid-bg opacity-15"></div>
      <div className="absolute top-1/4 left-1/3 w-96 h-96 bg-blue-600/10 rounded-full mix-blend-multiply filter blur-3xl opacity-15"></div>
      <div className="absolute bottom-1/4 right-1/3 w-96 h-96 bg-indigo-600/10 rounded-full mix-blend-multiply filter blur-3xl opacity-15"></div>
      ...
      <div className="container mx-auto px-4 md:px-12 relative z-10">
        <ScrollReveal direction="scale">
          <h2 className="text-2xl md:text-4xl mobile-heading text-center mb-8 md:mb-16 relative text-outline">
            ...
            <span className="digital-text text-3xl md:text-5xl section-title">
              Current Trends
              {/* 装飾ライン */}
        ...
        <div className="max-w-5xl mx-auto futuristic-card p-5 md:p-12 rounded-xl shadow-lg animate-fadeIn important-section">
          <div className="flex flex-col md:flex-row gap-6 md:gap-8 items-start mb-8 md:mb-12">
            ...
            <div className="md:w-3/4">
              <h3 className="text-xl md:text-2xl font-medium mb-3 md:mb-4 digital-text highlight-text important-text">
                生成AI
              </h3>
              <p className="text-white leading-relaxed mb-4 md:mb-6 mobile-readable text-outline">
                最近のトレンドは生成AIです。情報を得るのが大変で常に頭を動かしています。最新技術の動向に敏感で、特に生成AIの可能性と活用方法に強い関心を持っています。
              </p>

              <div className="bg-black/80 backdrop-blur-sm p-4 md:p-6 rounded-lg mb-4 md:mb-6 border border-blue-500/40 relative">
                {/* コーナーアクセント */}
                ...
                <p className="text-white italic mobile-readable text-outline">
              ...
              <div className="flex flex-wrap gap-2 md:gap-3">
                {["生成AI", "テクノロジー", "イノベーション", "自己啓発"].map((tag, index) => (
                  <span
                    key={index}
                    className="px-2 md:px-3 py-1 bg-gradient-to-r from-blue-500/30 to-indigo-500/30 text-white rounded-full text-xs md:text-sm hover-lift font-medium border border-blue-500/40 text-outline"
                  >
                    {tag}
                  </span>
                ))}
          ...
          <div className="mt-8 animate-fadeIn animate-delay-200">
            <h4 className="text-lg md:text-xl font-medium mb-4 md:mb-6 pb-2 border-b border-blue-500/40 digital-text highlight-text important-text">
              実際使用したAIのオススメ+使用熟練度
            </h4>
            <p className="text-white mb-4 md:mb-6 mobile-readable text-outline">
              ★が多いほどオススメかつ私自身の使用練度が高い意味を示しています。
            </p>

            <div className="mb-6 md:mb-10">
              <h5 className="text-base md:text-lg font-medium mb-3 md:mb-4 bg-gradient-to-r from-blue-500/30 to-indigo-500/30 p-2 rounded-lg border-l-2 border-blue-500 text-outline">
                仕事使用可能
              </h5>
                  ...
                  <div key={index} className="data-display rounded-lg hover-lift relative">
                    <div className="flex justify-between items-start">
                      <a
                        ...
                        className="font-medium text-blue-300 hover:text-white mobile-link-white mobile-readable text-outline"
                      >
                        {tool.name}
                      </a>
                      <span className="text-yellow-300 text-sm md:text-base font-bold">{tool.rating}</span>
                    </div>
                    <p className="text-white mobile-readable mt-1 text-outline">{tool.description}</p>
            ...
            <div className="animate-fadeIn animate-delay-300">
              <h5 className="text-base md:text-lg font-medium mb-3 md:mb-4 bg-gradient-to-r from-indigo-500/30 to-purple-500/30 p-2 rounded-lg border-l-2 border-indigo-500 text-outline">
                個人的趣味で使用可能
              </h5>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-4">
